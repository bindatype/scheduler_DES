...
#+NUM_OF_SHORT_NODES+NUM_OF_384_NODES+NUM_OF_NANO_NODES
...
if rank == 0:
	...
	if size >= 3:
		print("384gb\t%.2f\t%.2f\t%.2f\t%.2f\t%d\t%.0f\t%.0f\t%d" % (stats[2][0]/3600,stats[2][1]/3600,stats[2][2]/3600,stats[2][3]/3600,jobdata[2],run_sum[2]/3600,run_sum[2]/3600/NUM_OF_384_NODES,NUM_OF_384_NODES))
